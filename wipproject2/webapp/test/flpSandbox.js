		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "wippoc2",
									"targetURL": "#comchappotawippoc2wipproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchappotawippoc2wipproject2-display": {
								"semanticObject": "comchappotawippoc2wipproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chappota.wippoc2.wipproject2",
									"url": sap.ui.require.toUrl("com/chappota/wippoc2/wipproject2")
								}
							}
						}
					}
